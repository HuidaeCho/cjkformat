...
This Python 3 module provides utility functions for formatting fixed-width CJK strings. Functionally, it is similar to the [libaprintf](https://github.com/HuidaeCho/libaprintf) (aligned printf) C library.
